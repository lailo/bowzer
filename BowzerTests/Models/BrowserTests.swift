...
final class BrowserTests: XCTestCase {
    ...
    func testBrowserDisplayItem_IdFormat_WithProfile() {
        // Profile ID already includes bundle identifier (as created by ProfileDetectionService)
        let profile = BrowserProfile(id: "com.google.Chrome_Default", name: "Personal", directoryName: "Default")
        ...
        // Display item uses profile ID directly (no double-prefixing)
        XCTAssertEqual(item.id, "com.google.Chrome_Default")
    }
